...
public abstract class AbstractDrawingCommand extends MouseAdapter implements
	...
	/**
	 * Returns the name of a DrawingCommand. The value of the String returned 
	 * is the name of the class of which the DrawingCommand object is an 
	 * instance of. E.g. given an instance of Pen (a known subclass of 
	...
	/**
	 * Intended to be called by subclasses to notify registered listeners of
	 * the progress of executing a DrawingCommand.
	 * @param event
	 */
